...
const HF_API_KEY = "hf_DEIN_KEY_HIER"; // <-- ersetzen
const HF_MODEL_URL =
  ...
  return (
    <div className="flex flex-col items-center">
      <svg viewBox="0 0 200 120" className="w-56 h-36">
        ...
        {/* Labels */}
        <text x="18" y="125" fill="#64748b" fontSize="9" fontFamily="monospace">
          MENSCH
        </text>
        <text x="140" y="125" fill="#64748b" fontSize="9" fontFamily="monospace">
          KI
        </text>
      </svg>
      <div
...
export default function App() {
  ...
  const runScan = async (f) => {
    ...
    try {
      ...
      // Parse result: [{label: "artificial", score: 0.93}, {label: "human", score: 0.07}]
      const aiEntry = data.find(
...
Powered by HuggingFace AI-Detektor
  ...
  return (
    ...
    >
      ...
      >
        {/* AdSense: data-ad-slot="XXXX" data-ad-client="ca-pub-XXXX" */}
      ...
      <header style={{ padding: "40px 20px 20px", textAlign: "center" }}>
        ...
        <h1
          style={{
            ...
            letterSpacing: "-1px",
            margin: "0 0 8px",
            background: "linear-gradient(135deg, #06b6d4 0%, #e2e8f0 60%)",
        ...
        <p style={{ color: "#64748b", fontSize: "14px", margin: "0", maxWidth: "480px", display: "inline-block" }}>
          Lade ein Bild hoch. Unsere KI analysiert in Sekunden, ob es{" "}
          <span style={{ color: "#06b6d4" }}>KI-generiert</span> oder{" "}
          <span style={{ color: "#22c55e" }}>menschlich erstellt</span> ist.
        </p>
      </header>
      ...
      <main style={{ maxWidth: "640px", margin: "0 auto", padding: "0 16px 40px" }}>
          ...
          {phase === "idle" && (
            <div
              ...
              style={{
                ...
                textAlign: "center",
                cursor: "pointer",
                border: `2px dashed ${dragOver ? "#06b6d4" : "#334155"}`,
                margin: "24px",
                borderRadius: "12px",
            ...
            <div style={{ padding: "32px" }}>
              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                >
                  ...
                  <span style={{ color: "#06b6d4" }}>{scanProgress}%</span>
                </div>
              </div>
              {/* Status messages */}
              {SCAN_STEPS.slice(0, scanStep + 1).map((s, i) => (
                <div
                  ...
                  style={{
                    fontSize: "12px",
                    color: i === scanStep ? "#06b6d4" : "#475569",
                    padding: "3px 0",
                    display: "flex",
                    alignItems: "center",
                    gap: "8px",
                ...
                {preview && (
                  <img
                    ...
                    style={{
                      ...
                      objectFit: "cover",
                      borderRadius: "8px",
                      border: `2px solid ${result.isAI ? "#ef4444" : "#22c55e"}`,
                      flexShrink: 0,
                    }}
                  />
                )}
                <div style={{ flex: 1 }}>
                  <div
                    style={{
                      ...
                      border: `1px solid ${result.isAI ? "#ef4444" : "#22c55e"}`,
                      marginBottom: "12px",
                    }}
                  >
                  ...
                  <div style={{ fontSize: "12px", color: "#64748b", lineHeight: "1.8" }}>
                    <div>
                      KI-Wahrscheinlichkeit:{" "}
                      <span style={{ color: "#ef4444", fontWeight: "700" }}>{result.aiScore}%</span>
                    </div>
                    <div>
                      Mensch-Wahrscheinlichkeit:{" "}
                      <span style={{ color: "#22c55e", fontWeight: "700" }}>{result.humanScore}%</span>
                    </div>
                    {result.demo && (
                      <div style={{ color: "#f97316", fontSize: "10px", marginTop: "4px" }}>
                        ⚠ Demo-Modus – API-Key nicht gesetzt
                      </div>
                    )}
                  </div>
                </div>
        ...
        <div style={{ marginTop: "32px", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "12px" }}>
          {[
            { icon: "📤", title: "1. Hochladen", text: "Drag & Drop oder Datei auswählen" },
            { icon: "🔬", title: "2. Analysieren", text: "KI prüft Pixel, Metadaten & Muster" },
            { icon: "📊", title: "3. Ergebnis", text: "Score + Download-Zertifikat" },
          ].map((item) => (
            <div
              key={item.title}
              style={{
      ...
      >
        ...
        <div style={{ fontSize: "11px", color: "#334155" }}>
          © 2025 istdasvoneinerki.de · Powered by HuggingFace AI ·{" "}
